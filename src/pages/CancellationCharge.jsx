...
import { CancellationChargeSchema } from "schemas";
...
const CancellationCharge = () => {
  ...
  const validationSchema = CancellationChargeSchema.reduce(
    (accumulator, currentValue) => {
    ...
    >
      <Card sx={{ width: { lg: 500, md: 500, sm: 400, sx: 300 }, mt: "8vh" }}>
        <CardHeader
          ...
          subheader="Set the cancellation charge"
        ...
        <Formik
          ...
          enableReinitialize
          initialValues={
            config?.cancellation?.percentage
              ? {
                  percentage: config?.cancellation?.percentage,
                  maxCharge: config?.cancellation?.maxCharge,
                  minTimePercentage: config?.cancellation?.minTimePercentage,
                }
              : initialValues
          }
        >
          {({ isSubmitting, isValid }) => (
            <Form>
              <CardContent>
                {CancellationChargeSchema?.map((inputItem) => (
